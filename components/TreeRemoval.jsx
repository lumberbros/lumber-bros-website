...
const TRHero = () => {
  ...
  return (
    <section className="tr-hero-v2" style={{ padding: "28px 0px" }}>
          ...
          <div className="tr-hero-v2-text">
            <div className="tr-hero-v2-headline" style={{ gap: 28 }}>
              ...
              <h2 className="display tr-hero-v2-title" style={{
                ...
                <em style={{ fontStyle: "normal", color: "var(--lb-navy)", whiteSpace: "nowrap" }}>Tight-space</em> <span style={{ whiteSpace: "nowrap" }}>tree experts</span>
              </h2>
            </div>
...
const TRTrustBar = () => {
  ...
  { icon: "check", label: "No ruts or crushed flower beds" },
...
{ tone: "forest", tag: "On the job · Beaufort Co.", desc: "Climber 60ft up a leaning red oak, tag line set, ground crew below." },
{ tone: "dusk", tag: "Equipment · The mill", desc: "Bandsaw mill mid-cut on a 32-inch white oak butt log." },
{ tone: "amber", tag: "Crew · Pitt Co.", desc: "End-of-day cleanup — lawn raked, no ruts, ready to roll out." },
{ tone: "shop", tag: "Shop · Custom build", desc: "Live-edge walnut slab, dressed and ready for the customer." },
{ tone: "forest", tag: "On the job · Washington Co.", desc: "Rigging a section out over the roof line, tight setback." }];
...
const TRSaveCallout = () =>
<section className="section-tight" style={{ background: "var(--lb-forest)", color: "var(--lb-bone)" }}>
    <div className="container row-2-split">
      ...
      gridTemplateColumns: "1fr"
        ...
        <div style={{ padding: "28px 32px" }}>
          <div style={{ fontFamily: "var(--font-sans)", fontSize: 14, fontWeight: 700, color: "var(--lb-bone)" }}>We handle</div>
          <div style={{
          marginTop: 10,
        ...
        <div style={{ padding: "28px 32px" }}>
          <div style={{ fontFamily: "var(--font-sans)", fontSize: 14, fontWeight: 700, color: "var(--lb-sawdust)" }}>You handle</div>
          <div style={{
          marginTop: 10,
          fontFamily: "var(--font-display)",
          fontSize: "clamp(22px, 2.2vw, 28px)",
